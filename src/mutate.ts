...
// --- finding the code, past strings and comments ------------------------------
 ...
 *     whitespace rule below makes that unlikely and the mutation would
 *     still compile.
 ...
 * would be scored as killed and would overstate it.
 */
